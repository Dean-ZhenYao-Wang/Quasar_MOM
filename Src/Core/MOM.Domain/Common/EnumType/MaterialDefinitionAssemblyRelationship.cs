namespace MOM.Domain.Common.EnumType
{
    ...
    public enum MaterialDefinitionAssemblyRelationship
    {
        ...
        /// </summary>
        /// <remarks>
        /// 仅在生产过程中短暂存在的组合，例如装有多种物料的托盘、批次套件（batch kit）、工装夹具组合等。
        /// </remarks>
        [EnumMember(Value = "transient"), Display(Name = " ", Description = "仅在生产过程中短暂存在的组合，例如装有多种物料的托盘、批次套件（batch kit）、工装夹具组合等。")]
        transient
    }
}