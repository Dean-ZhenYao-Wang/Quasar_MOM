...
{
    public class OperationalLocationClassPropertyContainsRelationship : Relationship<Domain.isa95.CommonObjectModels.Part2.OperationalLocation.OperationalLocationClassProperty,Domain.isa95.CommonObjectModels.Part2.OperationalLocation.OperationalLocationClassProperty>, IEquatable<OperationalLocationClassPropertyContainsRelationship>
    {
        public OperationalLocationClassPropertyContainsRelationship():base()
        {
            Name = "contains";
        }
