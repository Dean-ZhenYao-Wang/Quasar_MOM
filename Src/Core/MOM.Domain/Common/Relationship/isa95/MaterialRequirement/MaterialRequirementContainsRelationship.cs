...
{
    public class MaterialRequirementContainsRelationship : Relationship<Domain.isa95.CommonObjectModels.Part2.OperationsSchedule.MaterialRequirement>, IEquatable<MaterialRequirementContainsRelationship>
    {
        ...
        public MaterialRequirementContainsRelationship(string sourceId, string targetId) : this()
        {
