...
{
    public class EquipmentActualIsMadeUpOfRelationship : Relationship<Domain.isa95.CommonObjectModels.Part2.OperationsPerformance.EquipmentActual>, IEquatable<EquipmentActualIsMadeUpOfRelationship>
    {
        ...
        public EquipmentActualIsMadeUpOfRelationship(string sourceId, string targetId) : this()
        {
