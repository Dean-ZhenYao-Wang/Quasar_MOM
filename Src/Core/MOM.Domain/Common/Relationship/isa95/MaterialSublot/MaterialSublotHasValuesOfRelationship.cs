...
{
    public class MaterialSublotHasValuesOfRelationship : Relationship<Domain.isa95.CommonObjectModels.Part2.Material.MaterialSublot ,Domain.isa95.CommonObjectModels.Part2.Material.MaterialLotProperty>, IEquatable<MaterialSublotHasValuesOfRelationship>
    {
        ...
        public MaterialSublotHasValuesOfRelationship(Guid? sourceId, Guid targetId) : this()
        {
