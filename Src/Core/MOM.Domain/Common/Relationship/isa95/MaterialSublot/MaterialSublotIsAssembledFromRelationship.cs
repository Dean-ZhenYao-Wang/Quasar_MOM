...
{
    public class MaterialSublotIsAssembledFromRelationship : Relationship<Domain.isa95.CommonObjectModels.Part2.Material.MaterialSublot>, IEquatable<MaterialSublotIsAssembledFromRelationship>
    {
        ...
        public MaterialSublotIsAssembledFromRelationship(string sourceId, string targetId) : this()
        {
