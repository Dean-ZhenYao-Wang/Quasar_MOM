...
{
    public class JobResponseCorrespondsToWorkDirectiveRelationship : Relationship<Domain.isa95.CommonObjectModels.Part4.WorkPerformance.JobResponse ,Domain.isa95.CommonObjectModels.Part4.WorkDefinition.WorkDirective>, IEquatable<JobResponseCorrespondsToWorkDirectiveRelationship>
    {
        ...
        public JobResponseCorrespondsToWorkDirectiveRelationship(Guid? sourceId, Guid targetId) : this()
        {
