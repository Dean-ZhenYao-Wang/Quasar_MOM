...
{
    public class JobResponseContainsPhysicalAssetRelationship : Relationship<Domain.isa95.CommonObjectModels.Part4.WorkPerformance.JobResponse,Domain.isa95.CommonObjectModels.Part2.OperationsPerformance.PhysicalAssetActual>, IEquatable<JobResponseContainsPhysicalAssetRelationship>
    {
        ...
        public JobResponseContainsPhysicalAssetRelationship(Guid? sourceId, Guid targetId) : this()
        {
