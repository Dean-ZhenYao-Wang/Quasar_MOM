namespace MOM.Domain.Common.Relationship.isa95.MaterialLot
{
    ...
    {
        public override string Name { get; set; } = "isAssembledFromSublot";

        public MaterialLotIsAssembledFromSublotRelationship(Domain.isa95.CommonObjectModels.Part2.Material.MaterialLot source, Domain.isa95.CommonObjectModels.Part2.Material.MaterialSublot target) : base(source, target)
        {
        }

        public MaterialLotIsAssembledFromSublotRelationship(Guid sourceId, Guid targetId) : base(sourceId, targetId)
        {
        }
