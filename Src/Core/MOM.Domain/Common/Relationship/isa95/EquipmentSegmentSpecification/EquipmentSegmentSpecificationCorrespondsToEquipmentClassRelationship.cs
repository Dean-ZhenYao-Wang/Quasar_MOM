...
{
    public class EquipmentSegmentSpecificationCorrespondsToEquipmentClassRelationship : Relationship<Domain.isa95.CommonObjectModels.Part2.PhysicalAssetAndEquipment.EquipmentClass>, IEquatable<EquipmentSegmentSpecificationCorrespondsToEquipmentClassRelationship>
    {
        ...
        public EquipmentSegmentSpecificationCorrespondsToEquipmentClassRelationship(string sourceId, string targetId) : this()
        {
