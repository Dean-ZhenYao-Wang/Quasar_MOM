...
using MOM.Application.Features.PhysicalAssetAndEquipment.Queries.GetEquipmentClassIncludesRelations;
using MOM.Application.Features.PhysicalAssetAndEquipment.Queries.GetEquipmentClassIsMadeUpOf;
...
namespace 设备管理.Controllers.v1
{
    ...
    public sealed class EquipmentClassController : BaseApiController
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<PagedResponse<EquipmentClass>> GetPaged([FromQuery] GetPagedEquipmentClassQuery query)
        {
