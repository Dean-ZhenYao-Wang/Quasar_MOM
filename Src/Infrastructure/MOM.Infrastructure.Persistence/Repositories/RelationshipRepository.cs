...
namespace MOM.Infrastructure.Persistence.Repositories
{
    ...
    public class HierarchyScopeRelationshipRepository<T, TSource, TTarget>(DbContext dbContext)
   : GenericRepository<T>(dbContext),
     IHierarchyScopeRelationshipRepository<T, TSource, TTarget>
        where T : HierarchyScopeRelationship<TSource, TTarget>, new()
           where TSource : class
